    ...
    return (
        <div className="min-h-screen bg-black text-white overflow-hidden relative">
            ...
            <div className="absolute inset-0">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,0,150,0.1),transparent_50%)]">
                </div>
                <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_48%,rgba(255,255,255,0.03)_49%,rgba(255,255,255,0.03)_51%,transparent_52%)] bg-[length:20px_20px] animate-pulse">
                </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] px-6">
                    ...
                    {links.map((link, index) => (
                        ...
                        >
                            ...
                            <div className="relative h-80 border border-white/10 bg-black/50 backdrop-blur-sm group-hover:border-white/30 transition-all duration-500 overflow-hidden">
                                ...
                                {/* Scan line effect */}
                                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/5 to-transparent h-20 w-full opacity-0 group-hover:opacity-100 group-hover:animate-pulse transition-opacity duration-500">
                                </div>
                            </div>
                        </a>
                    ))}
                ...
                <div className="mt-20 text-center">
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-red-500/20 via-pink-500/20 to-yellow-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                        </div>
