...
import { Camera, Layers, Lightbulb, Megaphone, Mic, Rocket, Target, Users } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto leading-relaxed">
          I&rsquo;ve spent years in the trenches, building systems that actually work. Not theory.
          Not hype. Just proven methods that turn content into results.
        </p>
      </motion.div>
