    ...
    >
      <div className="max-w-4xl mx-auto space-y-8">
        <motion.h3
          ...
          viewport={{ once: true }}
        >
          READY TO <span className="text-blue-600 dark:text-blue-500">DOMINATE</span> WITH
          AI-POWERED CONTENT?
        </motion.h3>
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Let&rsquo;s engineer your AI strategy to crush your content goals, captivate your ideal
          audience, and build your creator empire.
        </motion.p>
