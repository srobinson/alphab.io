  ...
  const sampleItems = [
    {
      ...
      pubDate: new Date(),
      description:
        "OpenAI reveals significant advances in their next-generation AI model with unprecedented reasoning capabilities",
      source: "TechCrunch",
    ...
    },
    {
      ...
      description:
        "Expert analysis on how artificial intelligence is transforming business operations across industries",
...
async function main() {
  ...
  try {
    ...
    console.log(
      '3. Test cron endpoint: curl -H "Authorization: Bearer your-secret" /api/cron/content-sync'
    );
