      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            We couldn't load the contact form right now. You can still reach us directly via email
            or try again.
          </p>
          ...
          <div className="space-y-3">
            ...
            <Button
              variant="outline"
              onClick={() => {
                window.location.href = "mailto:contact@alphab.io";
              }}
              className="w-full"
            >
