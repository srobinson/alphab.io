// Hero reveal that introduces AlphaB as a personal AI expert offering direct access, setting the stage for showcasing RADE consulting services without corporate layers
"use client";
    ...
    <div className="relative pt-10 Xmin-h-screen Xoverflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-20 text-center px-6 max-w-7xl mx-auto -mt-2 md:-mt-2">
          ...
          <div className="space-y-2">
            ...
            <div
              className={`font-black tracking-tight transition-all duration-600 ease-out
                                ...
                                leading-[1.0] pb-4 ${
                                  isVisible
                                    ? "transform translate-y-0 opacity-100 rotate-1"
                                    : "transform translate-y-8 opacity-0 rotate-0"
                                }`}
              style={{
                fontFamily: "'Inter', -apple-system, BlinkMacSystemFont, sans-serif",
                fontWeight: 900,
        ...
        <div className="mb-2 mt-12 overflow-hidden">
          <p
            className={`text-xl md:text-2xl lg:text-3xl text-gray-300 font-medium tracking-wide transition-all duration-600 ease-out ${
              isVisible
                ? "transform translate-y-0 opacity-100"
