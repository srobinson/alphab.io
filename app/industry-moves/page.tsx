					...
					<div className="grid md:grid-cols-3 gap-8">
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400">
								Get instant access to breaking AI developments and industry
						...
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400">
								Understand the implications of industry moves for your AI
						...
						<div className="p-6">
							...
							<p className="text-gray-600 dark:text-gray-400">
								Handpicked content from TechCrunch, VentureBeat, The Verge, and
